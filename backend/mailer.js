  ...
  const html = `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #222;">
      ...
      <table style="width:100%; border-collapse:collapse; margin-top:16px;">
        ...
        <tr><td style="padding:8px 0; color:#666;">투어명</td><td style="padding:8px 0;">${booking.tourName}</td></tr>
        <tr><td style="padding:8px 0; color:#666;">예약자</td><td style="padding:8px 0;">${booking.name}</td></tr>
        <tr><td style="padding:8px 0; color:#666;">이메일</td><td style="padding:8px 0;">${booking.email}</td></tr>
        <tr><td style="padding:8px 0; color:#666;">인원</td><td style="padding:8px 0;">${booking.travelers}명</td></tr>
        <tr><td style="padding:8px 0; color:#666;">날짜</td><td style="padding:8px 0;">${booking.date}</td></tr>
